...
class _SearchScreenState extends State<SearchScreen>
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: <Widget>[
                              ...
                              getPList(myController.text.toString(), state.hotels) +
                              [
                                SizedBox(
                                  height:
  ...
  List<Widget> getPList(String serachValue, List<Hotel> lastsSearchesList) {
    List<Widget> noList = [];
    var cout = 0;
    final columCount = 2;
    List<Hotel> custList = lastsSearchesList
        .where((element) =>
