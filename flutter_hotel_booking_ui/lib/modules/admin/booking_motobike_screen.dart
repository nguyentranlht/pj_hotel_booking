...
class BookingMotobikeScreen extends StatefulWidget {
  final AnimationController animationController;

  const BookingMotobikeScreen({Key? key, required this.animationController})
      : super(key: key);
  @override
  _BookingMotobikeScreenState createState() => _BookingMotobikeScreenState();
}

class _BookingMotobikeScreenState extends State<BookingMotobikeScreen>
      ...
      list.add(
        HotelListViewPage(
          callback: () {
            ...
            NavigationServices(context).gotoUpdateHotel(f);
          },
          hotelData: f,
          animation: animation,
          animationController: widget.animationController,
