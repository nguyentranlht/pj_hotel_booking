...
import 'package:flutter_hotel_booking_ui/modules/admin/room_hotel_view.dart';
import 'package:flutter_hotel_booking_ui/utils/text_styles.dart';
import 'package:room_repository/room_repository.dart';
import '../../futures/get_room_bloc/get_room_bloc.dart';

class RoomHotelScreen extends StatefulWidget {
  final String hotelName;
  final String hotelId;
  const RoomHotelScreen(
      {Key? key, required this.hotelName, required this.hotelId})
      : super(key: key);
  @override
  _RoomHotelScreenState createState() => _RoomHotelScreenState();
}

class _RoomHotelScreenState extends State<RoomHotelScreen>
